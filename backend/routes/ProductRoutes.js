...
const { CreateProductListing,FetchSellerProducts,AllProducts,GetProductById,FetchApprovedProducts,SearchProducts} = require("../controllers/ProductControllers")
...
router.route('/products/category/:query').get()  //Get All Products by Subcategory
